...
import type { MemberRegistrationItem } from '@/types'

export function useStudentRegistration(initialData: MemberRegistrationItem[]) {
  ...
  const updateStatus = (newStatus: MemberRegistrationItem['status']) => {
    setItems((prev) =>
      prev.map((item) =>
